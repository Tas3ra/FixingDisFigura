...
/*    public static void useFiguraGuiFramebuffer() {
    ...
    public static void drawEntity(float x, float y, float scale, float pitch, float yaw, LivingEntity entity, GuiGraphics gui, Vector3f offset, EntityRenderMode renderMode, int x1, int y1, int x2, int y2) {
        ...
        EntityRenderer<? super LivingEntity, LivingEntityRenderState> entityRenderer = getLivingEntityRenderer(entityRenderDispatcher, entity);
    ...
    private static EntityRenderer<? super LivingEntity, LivingEntityRenderState> getLivingEntityRenderer(EntityRenderDispatcher dispatcher, LivingEntity entity) {
        return (EntityRenderer<? super LivingEntity, LivingEntityRenderState>) dispatcher.getRenderer(entity);
    }
