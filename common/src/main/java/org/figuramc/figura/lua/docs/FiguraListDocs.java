...
public class FiguraListDocs {
    ...
    private enum ListDoc {
        ...
        private JsonElement generateJson(boolean translate) {
            ...
            for (Object o : coll) {
                if (o instanceof Map.Entry<?, ?> e) {
                    ...
                    for (Object value : aliases(e.getValue()))
                    ...
                    if (o instanceof Map.Entry<?, ?> e) {
                        ...
                        for (Object value : aliases(e.getValue())) {
                            component.append(Component.literal(" | ").withStyle(ChatFormatting.YELLOW))
                                    .append(Component.literal(value.toString()).withStyle(ChatFormatting.GRAY));
                        }
                    } else {
        ...
        private static Collection<?> aliases(Object value) {
